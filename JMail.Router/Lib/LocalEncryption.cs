...
namespace JMail.Relay.Lib
{
    ...
    {
        public static string Key = "tempkey123";
        ...
        public static string Encrypt(string clearText) => Convert.ToBase64String(EncryptString(clearText, Key));
        public static string Decrypt(string encryptedText) => DecryptToString(Convert.FromBase64String(encryptedText), Key);


        private static byte[] EncryptString(string toEncrypt, string password)
        {
            // encrypt
        ...
        private static string DecryptToString(byte[] encryptedData, string password)
        {
